...
Continue only after the printed version is `1.0.10`.
...
```bash
npm view @golba98/codexa@1.0.10 version
npm install -g @golba98/codexa@1.0.10
codexa --version
```
...
git commit -m "release: prepare Codexa v1.0.10"
git tag v1.0.10
